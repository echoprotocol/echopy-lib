class HistoryApi:
    ...
    def get_account_history(self, account_id, stop="1.11.0", limit=100, start="1.11.0"):
    ...
    def get_account_history_operations(self, account_id, operation_id, stop="1.11.0", limit=100, start="1.11.0"):
        return self.db.rpcexec('get_account_history_operations', [account_id, operation_id, start, stop, limit])

    def get_contract_history(self, contract_id, stop="1.11.0", limit=100, start="1.11.0"):

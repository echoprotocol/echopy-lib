...
class DatabaseApi:
    ...
    async def get_git_revision(self):
        return await self.db.rpcexec(
            'get_git_revision',
            []
        )
    
    async def get_current_incentives_info(self):
        return await self.db.rpcexec(
            'get_current_incentives_info',
            []
        )

    async def get_incentives_info(self, start_block, end_block):
        return await self.db.rpcexec(
            'get_incentives_info',
    ...
    async def get_account_address_by_label(self, account_name_or_id, label):
        return await self.db.rpcexec(
